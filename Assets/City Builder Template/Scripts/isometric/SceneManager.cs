...
public class SceneManager : MonoBehaviour
{
	...
	public void Init()
	{
		...
		this.numberOfGoldInStorage = 20000;
	...
	public BaseItemScript AddItem(int itemId, int instanceId, int posX, int posZ, bool immediate, bool ownedItem)
	{
		...
		BaseItemScript instance = Utilities2.CreateInstance(this.BaseItem, this.ItemsContainer, true).GetComponent<BaseItemScript>();
    ...
    {
		GameObject inst = Utilities2.CreateInstance(prefab, this.ParticlesContainer, true);
