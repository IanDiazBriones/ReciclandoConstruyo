...
public class ShopWindowScript : WindowScript {
	...
	public void RenderCategories(){
		...
		for (int index = 0; index < categories.Length; index++) {
			GameObject inst = Utilities2.CreateInstance (this.CategoryItem, this.ItemsList, true);
	...
	public void RenderSubCategories(Category category){
		...
		for(int index=0; index<subItems.Length; index++){
			GameObject inst = Utilities2.CreateInstance (this.SubCategoryItem, this.ItemsList, true);
